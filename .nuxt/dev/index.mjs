...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, eventHandler, getRouterParam, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getQuery as getQuery$1, getResponseStatusText } from 'file://E:/note/study/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://E:/note/study/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/note/study/node_modules/devalue/index.js';
import destr from 'file://E:/note/study/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://E:/note/study/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://E:/note/study/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://E:/note/study/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://E:/note/study/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://E:/note/study/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://E:/note/study/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://E:/note/study/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://E:/note/study/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://E:/note/study/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://E:/note/study/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://E:/note/study/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://E:/note/study/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://E:/note/study/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file://E:/note/study/node_modules/vue/index.mjs';
import { createStorage, prefixStorage } from 'file://E:/note/study/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/note/study/node_modules/unstorage/drivers/fs.mjs';
import { isAbsolute } from 'file://E:/note/study/node_modules/pathe/dist/index.mjs';
import localAdapter from 'file://E:/note/study/node_modules/db0/connectors/better-sqlite3.mjs';
import { hash } from 'file://E:/note/study/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/note/study/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/note/study/node_modules/@unhead/shared/dist/index.mjs';
...
const _HFlRCSCG7q = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "E:/note/study";
...
const _IuhzQv = eventHandler(async (event) => {
  ...
  return await import('file://E:/note/study/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
async function _checkAndImportDatabaseIntegrity(event, collection, integrityVersion, config) {
  ...
  await dump.reduce(async (prev, sql) => {
    await prev;
    await db2.exec(sql).catch((err) => {
      const message = err.message || "Unknown error";
      console.error(`Failed to execute SQL ${sql}: ${message}`);
    });
  }, Promise.resolve());
  const after = await db2.first(`SELECT * FROM ${tables.info} WHERE id = ?`, [`checksum_${collection}`]).catch(() => ({ version: "" }));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "E:/note/study/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const serverAssets = [{"baseName":"server","dir":"E:/note/study/server/assets"}];
...
const _wBSlvx = eventHandler(async (event) => {
...
const _lazy_Nyyuuz = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Nyyuuz, lazy: true, middleware: false, method: undefined },
  { route: '/api/content/:collection/database.sql', handler: _IuhzQv, lazy: false, middleware: false, method: undefined },
  { route: '/api/content/:collection/query', handler: _wBSlvx, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Nyyuuz, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://E:/note/study/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://E:/note/study/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
